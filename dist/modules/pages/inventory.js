...
function refreshFilteredTable() {
    ...
    const lowOnly = Boolean(document.getElementById('lowOnlyFilter')?.checked);
...
export function bindInventory(onDone) {
    ...
    document.getElementById('stockMoveForm')?.addEventListener('submit', (e) => {
        ...
        if (!validateRequired([['Produto', productId], ['Justificativa', reason]]))
            return;
